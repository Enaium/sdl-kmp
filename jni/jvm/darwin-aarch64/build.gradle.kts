 ...
 * Ships libsdl_jni.dylib as a classpath resource at
 * /cn/enaium/sdl/native/darwin-aarch64/, which NativeLoader
...
val buildJniLibrary by tasks.registering(Exec::class) {
    group = "build"
    description = "Builds libsdl_jni.dylib for $classifier."
    onlyIf { canBuildHere }
